...
int main(int argc, char **argv) {
    ...
    // process, causing it to detach from the terminal.
    // fat_volume_unmount() will not be called until the filesystem is
    // unmounted and fuse_main() returns in the daemon process.
